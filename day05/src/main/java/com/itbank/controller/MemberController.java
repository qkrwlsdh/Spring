...
public class MemberController {
	...
	public ModelAndView infoUpdate(@RequestParam HashMap<String, String> param, HttpSession session) {	// Hash<key, value> param
		...
		case 1:
			...
			MemberDTO login = memberService.getMember(param.get("userid"), param.get("userpw2"));
			session.setAttribute("login", login);
			break;
		case -1:
