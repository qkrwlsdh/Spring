...
public class PhoneBookController {
	...
	@GetMapping(value="phonebook/{search}", produces="application/json;charset=utf8")
	public String phoneBookSearch(@PathVariable String search) throws JsonProcessingException {
		List<PhoneBookDTO> list = ps.getPhoneBookList(search);
		String data = mapper.writeValueAsString(list);
		return data;
	}
	...
	public int phoneBookUpdate(@RequestBody PhoneBookDTO dto) {
		System.out.println(dto.getIdx());
		System.out.println(dto.getName());
		System.out.println(dto.getPnum());
		int row = ps.updatePhoneBook(dto);
		return row;
	}
